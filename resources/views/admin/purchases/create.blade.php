        ...
        <div class="card-body">
            <form method="POST" action="{{ route("admin.purchases.store") }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control datetime {{ $errors->has('purchase_date') ? 'is-invalid' : '' }}" type="text" name="purchase_date" id="purchase_date" value="{{ old('purchase_date') }}" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control datetime {{ $errors->has('expiration_date') ? 'is-invalid' : '' }}" type="text" name="expiration_date" id="expiration_date" value="{{ old('expiration_date') }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('email_verification_limit') ? 'is-invalid' : '' }}" type="number" name="email_verification_limit" id="email_verification_limit" value="{{ old('email_verification_limit', '') }}" step="1">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('limit_used') ? 'is-invalid' : '' }}" type="number" name="limit_used" id="limit_used" value="{{ old('limit_used', '') }}" step="1">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control {{ $errors->has('is_active') ? 'is-invalid' : '' }}" name="is_active" id="is_active">
                        ...
                        @foreach(App\Models\Purchase::IS_ACTIVE_SELECT as $key => $label)
                            <option value="{{ $key }}" {{ old('is_active', '0') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                        @endforeach
                    </select>
