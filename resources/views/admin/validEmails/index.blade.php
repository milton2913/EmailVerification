...
@section('content')
    @can('valid_email_create')
        <div style="margin-bottom: 10px;" class="row">
            <div class="col-lg-12">
                <a class="btn btn-success" href="{{ route('admin.valid-emails.create') }}">
                    {{ trans('global.add') }} {{ trans('cruds.validEmail.title_singular') }}
                </a>
                <button class="btn btn-warning" data-toggle="modal" data-target="#csvImportModal">
                    {{ trans('global.app_csvImport') }}
                </button>
                @include('csvImport.modal', ['model' => 'ValidEmail', 'route' => 'admin.valid-emails.parseCsvImport'])
            </div>
        </div>
    @endcan
    <div class="card">
        <div class="card-header">
            {{ trans('cruds.validEmail.title_singular') }} {{ trans('global.list') }}
        </div>
